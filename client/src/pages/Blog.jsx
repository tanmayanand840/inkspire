      ...
      <div className='mx-5 max-w-5xl md:mx-auto my-10 mt-6'>
        ...
        <div className='max-w-3xl mx-auto'>
          ...
          <form onSubmit={addComment} className='flex flex-col items-start gap-4 max-w-lg'>
            <input type="text" placeholder='Name' className='w-full p-2 border border-gray-300 rounded outline-none' onChange={(e)=>setName(e.target.value)} value={name} />

            <textarea placeholder='Comment' className='w-full p-2 border border-gray-300 rounded outline-none h-48' onChange={(e)=>setContent(e.target.value)} value={content} required></textarea>
